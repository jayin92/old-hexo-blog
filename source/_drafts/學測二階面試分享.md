---
title: 110 成大普渡雙聯組 & 清交APCS組 個人申請分享
...
自己雖然學測沒有考好，但我的備審還算不錯，特別是旺宏獎加分很多。評估之後覺得自己應該滿有機會的，所以決定試試看，不然旺宏科學獎的推薦函就浪費了。
...
把這個成績輸入到[落點分析網站](https://www.com.tw/)可以看到六顆星的大概有這幾間：
...
基本上跟台清交成(成大看國文)的電資一般組無緣了啦，不過APCS組和成大普渡雙聯組還可以拚一下，所以我最後決定還是同時準備指考和個人申請，到時候如果有上再決定要不要指考。
...
可以提一下我選成大電機的普渡雙聯組而非資工的原因，主要是因為成大電機一階篩的人比較多，上的機率比較大。而且我對於電機會上到的電磁學等等物理並不排斥，所以就決定填電機而非資工。
...
因為這個組是與普渡大學進行雙聯學制，所以面試是採全英文。一開始需要自我介紹2分鐘，後面則是教授Q&A六分鐘。Q&A部份如果真的沒辦法用英文回答，可以改用中文，不過我覺得如果真的改用中文應該會滿扣分的。
...
應該還有其他問題，不過我忘記了。我以為會問很多專題，結果好像沒有。當下就覺得好像不太妙。
...
準備就自我介紹背一下就差不多了，不過因為演算法問題被清大嚇到，所以這面試前有很認真準備相關的題目。

### 面試當天

面試當天主要有三個教授，不過問我問題的只有兩個教授。
...
我在打這篇文章的當下還沒有任何一間學校放榜，所以我也不知道自己有沒有機會上榜，期待我可以正取。